...
def nerd_dictation_process(text):
    global is_active, is_active_dictation
    ...
    while i < len(words_input):
        ...
        if is_active:
            ...
            if match_words_at_index(words_input, i, START_COMMAND):
                ...
                continue
            if match_words_at_index(words_input, i, START_Mouse):
                is_active_mouse = True
                os.system("play mouse.wav -q")
                i += len(START_Mouse)
                continue
            if match_words_at_index(words_input, i, FINISH_Mouse):
                is_active_mouse = False
            ...
            if is_active_mouse:
                ...
                if match_words_at_index(words_input, i, Open_gmail):
                    ...
                    i += len(Open_gmail)
                    continue
                if match_words_at_index(words_input, i, Mouse_kill):
